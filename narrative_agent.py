...
class NarrativeAgent:
    ...
    def build_narrative(self, report_data: dict) -> str:
        ...
        prompt = (
            ...
            f"5. If any answer contains code blocks (surrounded by triple backticks), you must include them in the report section where they are relevant. "
            f"Use the exact code if possible. Include at least one snippet per major section if available.\n"
